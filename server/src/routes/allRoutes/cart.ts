...
import {
  getCartUser,
  getDishInfoQtyInput,
} from "../../controllers/cartControllers/get.js";
import {
  decQtyCart,
  delCart,
  delItem,
...
import {
  saveDbStorageCart,
  switchCartFromLocalStorage,
  switchCartLogged,
} from "../../controllers/cartControllers/switch.js";
...
router.post(
  "/save-db-cart",
  verifyAccessToken,
  validateCartLocalStorage,
  asyncWrapper(saveDbStorageCart)
);
...
router.put(
  ...
  verifyAccessToken,
  validateCartLocalStorage,
  asyncWrapper(switchCartFromLocalStorage)
);
