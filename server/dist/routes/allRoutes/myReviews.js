...
import { createReview, getInfoRest, } from "../../controllers/myReviewsControllers/post.js";
...
router
    .route("/:restId")
    .post(uploadImgMyReviews, checkRestId, validateReview, asyncWrapper(createReview));
router
    .route("/:revId")
