...
export const validateGetMyRestParams = [
    ...
    check("search").custom((val, { req }) => { var _a; return val && !((_a = req === null || req === void 0 ? void 0 : req.query) === null || _a === void 0 ? void 0 : _a.searchVals) ? Promise.reject("Bad request 1") : true; }),
    check().custom((_, { req }) => {
        var _a;
