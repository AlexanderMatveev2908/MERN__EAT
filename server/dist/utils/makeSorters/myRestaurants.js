export const makeSortersMyRest = (req) => {
  var _a;
  const sorters = Object.entries(
    (_a = req.query) !== null && _a !== void 0 ? _a : {}
  )
  ...
  return Object.keys(sorter !== null && sorter !== void 0 ? sorter : {}).length
    ? sorter
    : null;
};
