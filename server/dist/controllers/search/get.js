...
export const getRestaurantsSearchAllUsers = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield Restaurant.aggregate([
        ...
        {
            $set: Object.assign({ deliveryTime: "$delivery.estTimeDelivery", deliveryPrice: "$delivery.price", dishesCount: { $size: "$dishes" }, reviewsCount: { $size: "$reviews" }, avgPrice: {
                    $ifNull: [
                        {
                            $avg: {
                                $map: {
        ...
        { $unset: ["orders", "__v", "dishes", "reviews"] },
